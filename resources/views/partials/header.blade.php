...
{{--                <ul class="navigation navbar-nav mr-auto" id="anchor-style">--}}
...
{{--                    <li class="nav-item navigation-item dropdown mega-dropdown ">--}}
{{--                        <a class="nav-link dropdown-toggle text-uppercase text-for-a px-1 pb-1" title="Все Коллекции"--}}
...
{{--                                        <li>--}}
{{--                                            <a class="menu-item pl-0" href="#">--}}
{{--                                                <i class="fas fa-caret-right pl-1 pr-3"></i>Laboris nisi ut aliquip ex--}}
...
{{--                                        <li>--}}
{{--                                            <a class="menu-item pl-0" href="#">--}}
{{--                                                <i class="fas fa-caret-right pl-1 pr-3"></i>Sed ut perspiciatis unde--}}

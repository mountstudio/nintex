    ...
    <nav class="navbar navbar-expand-lg navbar-light my-menu bg-transparent">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            ...
            <form class="form-inline my-2 my-lg-0 position-relative">
                <input
                    class="form-control mr-md-0 mr-sm-2 border-dark border-top-0 border-right-0 border-left-0 rounded-0"
                    style="background:#E5E5E5;width: 280px!important" type="search" placeholder="Search">
                <button
                    class="bg-transparent border-bottom-0 border-top-0 border-right-0 border-left-0 rounded-0 my-2 my-sm-0 position-absolute"
                    style="right: 0px; z-index: 5;" type="submit"><img src="img/search.png" class="img-fluid w-75"
                                                                       alt=""></button>
            </form>

var SelectPure = function () {
    "use strict";
    const t = {value: "data-value", disabled: "data-disabled", class: "class", type: "type"};

    class e {
        constructor(t, e = {}, s = {}) {
            return this._node = t instanceof HTMLElement ? t : document.createElement(t), this._config = {i18n: s}, this._setAttributes(e), e.textContent && this._setTextContent(e.textContent), this
        }
    ...
    return class {
        ...
        _selectOptions(t, s) {
            this._label.setText(""), this._icons = t.map(t => {
                const s = new e("span", {class: "select-pure__selected-label", textContent: t.label}),
        ...
        _unselectOption(t) {
            const e = [...this._config.value], s = e.indexOf(t.target.getAttribute("data-value"));
